...
- [`cds_basis_aggregated.parquet`](#cds-basis-aggregated-parquet)
- [`cds_basis_non_aggregated.parquet`](#cds-basis-non-aggregated-parquet)
- [`cds_basis_processed.parquet`](#cds-basis-processed-parquet)
- [`cds_basis_summary_stats.csv`](#cds-basis-summary-stats-csv)
- [`final_data_with_z_spread.parquet`](#final-data-with-z-spread-parquet)
...
- [`wrds_bondret_filtered.parquet`](#wrds-bondret-filtered-parquet)
- [`wrds_bondret_project.parquet`](#wrds-bondret-project-parquet)
#### Pull: Cds Returns
- [`fed_yield_curve.parquet`](#fed-yield-curve-parquet)
...
- [`CRSP_TFZ_consolidated_all_itypes.parquet`](#crsp-tfz-consolidated-all-itypes-parquet)
- [`CRSP_TFZ_with_runness.parquet`](#crsp-tfz-with-runness-parquet)
- [`CRSP_TFZ_with_runness_all_itypes.parquet`](#crsp-tfz-with-runness-all-itypes-parquet)
...
**Size:** 6.3 MB | **Type:** Parquet | **Shape:** 6,965 rows × 127 columns
...
```
BETA0: min=-462.138650263874, max=96.8290754439272, mean=-9.97, median=0.669404949465938
BETA1: min=-99.3850097536734, max=461.420596567779, mean=10.48, median=0.364590674947361
BETA2: min=-14714.5595849239, max=41780.5978932559, mean=180.33, median=1.36033356269305
BETA3: min=-41780.3392778245, max=15288.4854094759, mean=-179.82, median=7.452060262268805
BKEVEN02: min=-4.89120006561279, max=4.88600015640259, mean=1.84, median=1.90390002727509
BKEVEN03: min=-3.32570004463196, max=4.20620012283325, mean=1.83, median=1.87860000133514
BKEVEN04: min=-2.47009992599487, max=3.77729988098145, mean=1.86, median=1.92299997806549
BKEVEN05: min=-1.78219997882843, max=3.51519989967346, mean=1.91, median=1.98959994316101
BKEVEN06: min=-1.1933000087738, max=3.34069991111755, mean=1.96, median=2.0560998916626
BKEVEN07: min=-0.776600003242493, max=3.21379995346069, mean=2.01, median=2.10240006446838
BKEVEN08: min=-0.416900008916855, max=3.1136999130249, mean=2.06, median=2.14669990539551
BKEVEN09: min=-0.0997999981045723, max=3.05049991607666, mean=2.10, median=2.18650007247925
BKEVEN10: min=0.173700004816055, max=3.00090003013611, mean=2.14, median=2.22630000114441
BKEVEN11: min=0.404100000858307, max=3.0789999961853, mean=2.17, median=2.25760006904602
BKEVEN12: min=0.549300014972687, max=3.1528000831604, mean=2.20, median=2.28290009498596
BKEVEN13: min=0.591799974441528, max=3.21510004997253, mean=2.23, median=2.2985999584198
BKEVEN14: min=0.632600009441376, max=3.26559996604919, mean=2.24, median=2.31360006332397
BKEVEN15: min=0.672299981117249, max=3.30480003356934, mean=2.26, median=2.32719993591309
BKEVEN16: min=0.711499989032745, max=3.33360004425049, mean=2.27, median=2.33629989624023
BKEVEN17: min=0.750500023365021, max=3.35349988937378, mean=2.28, median=2.34409999847412
BKEVEN18: min=0.789799988269806, max=3.36640000343323, mean=2.29, median=2.34870004653931
BKEVEN19: min=0.829500019550323, max=3.37409996986389, mean=2.30, median=2.35179996490479
BKEVEN1F4: min=0.406300008296967, max=2.93309998512268, mean=2.11, median=2.20989990234375
BKEVEN1F9: min=0.869499981403351, max=3.85269999504089, mean=2.50, median=2.52250003814697
BKEVEN20: min=0.823199987411499, max=3.37890005111694, mean=2.31, median=2.3578999042511
BKEVEN5F05: min=0.823300004005432, max=3.59479999542236, mean=2.38, median=2.41580009460449
BKEVENF02: min=-2.51470620606936, max=4.08375659023234, mean=1.76, median=1.9010999989986401
BKEVENF03: min=-1.10940018234253, max=2.91150005741119, mean=1.88, median=2.047850008034705
BKEVENF04: min=0.0938000679016113, max=2.77920001516342, mean=2.03, median=2.157699973988535
BKEVENF05: min=0.693700015544891, max=3.02959990501404, mean=2.16, median=2.226899950599675
BKEVENF06: min=0.756199955940247, max=3.44410014152527, mean=2.27, median=2.303199994826315
BKEVENF07: min=0.810000002384186, max=3.74070000648499, mean=2.36, median=2.3938999029159547
BKEVENF08: min=0.826199933886528, max=3.79060006141663, mean=2.42, median=2.4385998845100447
BKEVENF09: min=0.850700005888939, max=3.81399989128113, mean=2.47, median=2.4859999243736253
BKEVENF10: min=0.886500030755997, max=3.87609994316101, mean=2.49, median=2.5172499946594247
BKEVENF11: min=0.933600008487701, max=3.94930004272461, mean=2.51, median=2.527304397062355
BKEVENF12: min=0.966799974441528, max=3.97090008277893, mean=2.51, median=2.5257999300956753
BKEVENF13: min=0.965099930763245, max=3.94850005111694, mean=2.50, median=2.508999943733215
BKEVENF14: min=0.985000014305115, max=3.90390005874634, mean=2.49, median=2.48780000705719
BKEVENF15: min=1.02630001306534, max=3.86670004043579, mean=2.48, median=2.48059994907379
BKEVENF16: min=0.83299994468689, max=3.81540005874634, mean=2.46, median=2.46937409405214
BKEVENF17: min=0.440399885177612, max=3.79940010070801, mean=2.45, median=2.452500111961365
BKEVENF18: min=0.0046000480651855, max=3.81200005531311, mean=2.44, median=2.430649757385255
BKEVENF19: min=-0.41729998588562, max=3.82190006523132, mean=2.43, median=2.42249999389648
BKEVENF20: min=-0.822000026702881, max=3.8208001083374, mean=2.42, median=2.426350035095215
BKEVENPY02: min=-4.74300003051758, max=4.97730016708374, mean=1.85, median=1.91559994220734
BKEVENPY03: min=-3.2234001159668, max=4.29759979248047, mean=1.85, median=1.88880002498627
BKEVENPY04: min=-2.3921000957489, max=3.87050008773804, mean=1.88, median=1.9326000213623
BKEVENPY05: min=-1.71399998664856, max=3.60809993743896, mean=1.92, median=1.99609994888306
BKEVENPY06: min=-1.1389000415802, max=3.43309998512268, mean=1.97, median=2.05819988250732
BKEVENPY07: min=-0.743300020694733, max=3.30579996109009, mean=2.02, median=2.10459995269775
BKEVENPY08: min=-0.39640000462532, max=3.20560002326965, mean=2.06, median=2.14580011367798
BKEVENPY09: min=-0.0943000018596649, max=3.12940001487732, mean=2.10, median=2.18359994888306
BKEVENPY10: min=0.163100004196167, max=3.07990002632141, mean=2.14, median=2.22309994697571
BKEVENPY11: min=0.37729999423027, max=3.05290007591248, mean=2.17, median=2.25239992141724
BKEVENPY12: min=0.539799988269806, max=3.11800003051758, mean=2.20, median=2.27670001983643
BKEVENPY13: min=0.580999970436096, max=3.17269992828369, mean=2.22, median=2.29679989814758
BKEVENPY14: min=0.620299994945526, max=3.21690011024475, mean=2.23, median=2.30890011787415
BKEVENPY15: min=0.65829998254776, max=3.25130009651184, mean=2.25, median=2.31970000267029
BKEVENPY16: min=0.695699989795685, max=3.2771999835968, mean=2.26, median=2.32999992370605
BKEVENPY17: min=0.732699990272522, max=3.29579997062683, mean=2.27, median=2.33859992027283
BKEVENPY18: min=0.769599974155426, max=3.30859994888306, mean=2.28, median=2.34360003471375
BKEVENPY19: min=0.806599974632263, max=3.3173999786377, mean=2.29, median=2.34750008583069
BKEVENPY20: min=0.787299990653992, max=3.3238000869751, mean=2.29, median=2.35159993171692
TAU1: min=0.100370192075799, max=29.9999993953736, mean=5.35, median=2.8247497484029
TAU2: min=0.477593867526314, max=30.0, mean=15.37, median=15.199956707331
TIPS1F04: min=-1.37679994106293, max=5.03329992294312, mean=1.48, median=1.45490002632141
TIPS1F09: min=-0.446399986743927, max=4.41830015182495, mean=2.03, median=2.19970011711121
TIPS5F5: min=-0.675899982452393, max=4.50890016555786, mean=1.85, median=2.02290010452271
TIPSF02: min=-2.27419996261597, max=7.30369997024536, mean=0.93, median=0.800800025463104
TIPSF03: min=-1.90729999542236, max=6.09499979019165, mean=1.18, median=1.08860003948212
TIPSF04: min=-1.5929000377655, max=5.34829998016357, mean=1.38, median=1.33449995517731
TIPSF05: min=-1.16069996356964, max=4.61959981918335, mean=1.55, median=1.58729994297028
TIPSF06: min=-0.939000010490417, max=4.52110004425049, mean=1.70, median=1.80159997940063
TIPSF07: min=-0.744400024414062, max=4.47819995880127, mean=1.82, median=1.97210001945496
TIPSF08: min=-0.580900013446808, max=4.43270015716553, mean=1.91, median=2.08940005302429
TIPSF09: min=-0.472499996423721, max=4.38969993591309, mean=1.99, median=2.16100001335144
TIPSF10: min=-0.417199999094009, max=4.35150003433228, mean=2.05, median=2.21239995956421
TIPSF11: min=-0.340900003910065, max=4.34070014953613, mean=2.09, median=2.24650001525879
TIPSF12: min=-0.304899990558624, max=4.34040021896362, mean=2.12, median=2.27069997787476
TIPSF13: min=-0.277799993753433, max=4.34019994735718, mean=2.14, median=2.27329993247986
TIPSF14: min=-0.255299985408783, max=4.34019994735718, mean=2.14, median=2.26519989967346
TIPSF15: min=-0.237100005149841, max=4.34019994735718, mean=2.14, median=2.24349999427795
TIPSF16: min=-0.222699999809265, max=4.34019994735718, mean=2.13, median=2.20729994773865
TIPSF17: min=-0.211400002241135, max=4.34019994735718, mean=2.10, median=2.15429997444153
TIPSF18: min=-0.202800005674362, max=4.34019994735718, mean=2.07, median=2.08929991722107
TIPSF19: min=-0.196199998259544, max=4.34019994735718, mean=2.04, median=2.0106999874115
TIPSF20: min=-0.191300004720688, max=4.34019994735718, mean=1.99, median=1.92030000686646
TIPSPY02: min=-3.10500001907349, max=5.67509984970093, mean=0.52, median=0.221699997782707
TIPSPY03: min=-2.54550004005432, max=4.68970012664795, mean=0.70, median=0.527800023555756
TIPSPY04: min=-2.18510007858276, max=4.40710020065308, mean=0.85, median=0.748799979686737
TIPSPY05: min=-1.94570004940033, max=4.41790008544922, mean=0.97, median=0.918900012969971
TIPSPY06: min=-1.7503000497818, max=4.41520023345947, mean=1.08, median=1.05340003967285
TIPSPY07: min=-1.57249999046326, max=4.4173002243042, mean=1.18, median=1.16460001468658
TIPSPY08: min=-1.41159999370575, max=4.41949987411499, mean=1.26, median=1.27980005741119
TIPSPY09: min=-1.2664999961853, max=4.41870021820068, mean=1.33, median=1.3914999961853
TIPSPY10: min=-1.13619995117188, max=4.41669988632202, mean=1.40, median=1.48889994621277
TIPSPY11: min=-1.03299999237061, max=4.41429996490479, mean=1.46, median=1.56019997596741
TIPSPY12: min=-0.961099982261658, max=4.41190004348755, mean=1.51, median=1.62109994888306
TIPSPY13: min=-0.89709997177124, max=4.4096999168396, mean=1.55, median=1.67460000514984
TIPSPY14: min=-0.83950001001358, max=4.4077000617981, mean=1.59, median=1.71749997138977
TIPSPY15: min=-0.787199974060059, max=4.40590000152588, mean=1.63, median=1.75750005245209
TIPSPY16: min=-0.739499986171722, max=4.40430021286011, mean=1.66, median=1.79320001602173
TIPSPY17: min=-0.695999979972839, max=4.4028000831604, mean=1.68, median=1.82739996910095
TIPSPY18: min=-0.663900017738342, max=4.40210008621216, mean=1.70, median=1.8478000164032
TIPSPY19: min=-0.638700008392334, max=4.4015998840332, mean=1.72, median=1.86150002479553
TIPSPY20: min=-0.615700006484985, max=4.40119981765747, mean=1.73, median=1.87160003185272
TIPSY02: min=-3.14680004119873, max=5.48320007324219, mean=0.52, median=0.222000002861023
TIPSY03: min=-2.57800006866455, max=4.5128002166748, mean=0.70, median=0.529999971389771
TIPSY04: min=-2.21950006484985, max=4.44169998168945, mean=0.84, median=0.751399993896484
TIPSY05: min=-1.96640002727509, max=4.43699979782104, mean=0.97, median=0.925700008869171
TIPSY06: min=-1.77489995956421, max=4.42269992828369, mean=1.08, median=1.05719995498657
TIPSY07: min=-1.60020005702972, max=4.41029977798462, mean=1.18, median=1.17890000343323
TIPSY08: min=-1.44149994850159, max=4.40049982070923, mean=1.26, median=1.29410004615784
TIPSY09: min=-1.29779994487762, max=4.39289999008179, mean=1.34, median=1.41480004787445
TIPSY10: min=-1.16820001602173, max=4.38670015335083, mean=1.41, median=1.51040005683899
TIPSY11: min=-1.06340003013611, max=4.38170003890991, mean=1.47, median=1.58229994773865
TIPSY12: min=-0.990899980068207, max=4.37750005722046, mean=1.52, median=1.64820003509521
TIPSY13: min=-0.92629998922348, max=4.37389993667603, mean=1.57, median=1.70780003070831
TIPSY14: min=-0.868099987506866, max=4.37090015411377, mean=1.61, median=1.75520002841949
TIPSY15: min=-0.815199971199036, max=4.36819982528687, mean=1.64, median=1.80330002307892
TIPSY16: min=-0.76690000295639, max=4.36590003967285, mean=1.67, median=1.84329998493195
TIPSY17: min=-0.722800016403198, max=4.36390018463135, mean=1.70, median=1.87070000171661
TIPSY18: min=-0.684400022029877, max=4.36210012435913, mean=1.72, median=1.89199995994568
TIPSY19: min=-0.658900022506714, max=4.3604998588562, mean=1.74, median=1.91199994087219
TIPSY20: min=-0.635599970817566, max=4.35900020599365, mean=1.75, median=1.92519998550415
```
...
**Size:** 3.2 MB | **Type:** Parquet | **Shape:** 16,763 rows × 31 columns
...
SVENY21                                  Float64         (40.7% null)
SVENY22                                  Float64         (40.7% null)
SVENY23                                  Float64         (40.7% null)
SVENY24                                  Float64         (40.7% null)
SVENY25                                  Float64         (40.7% null)
SVENY26                                  Float64         (40.7% null)
SVENY27                                  Float64         (40.7% null)
SVENY28                                  Float64         (40.7% null)
SVENY29                                  Float64         (40.7% null)
SVENY30                                  Float64         (40.7% null)
Date                                     Datetime(time_unit='ns', time_zone=None)
```

### Numeric Column Statistics
```
SVENY01: min=0.0554, max=16.462, mean=4.82, median=4.86985
SVENY02: min=0.102, max=15.9118, mean=5.01, median=4.8824
SVENY03: min=0.12720000743866, max=15.5746, mean=5.17, median=4.956488832885
SVENY04: min=0.168500006198883, max=15.3498, mean=5.31, median=5.077718566343499
SVENY05: min=0.221799999475479, max=15.1776, mean=5.43, median=5.214926478855
SVENY06: min=0.280600011348724, max=15.0611, mean=5.53, median=5.3401
SVENY07: min=0.341300010681152, max=15.0109, mean=5.63, median=5.4346169968255005
SVENY08: min=0.40200001001358, max=14.9799, mean=5.83, median=5.7830158488555
SVENY09: min=0.461800009012222, max=14.9572, mean=5.91, median=5.864063352660001
SVENY10: min=0.52020001411438, max=14.9398, mean=5.99, median=5.9285649481095
SVENY11: min=0.577000021934509, max=14.934, mean=6.05, median=5.956146052266
SVENY12: min=0.632300019264221, max=14.9367, mean=6.11, median=5.990458022852
SVENY13: min=0.685899972915649, max=14.9407, mean=6.16, median=6.033964087027
SVENY14: min=0.737999975681305, max=14.9684, mean=6.20, median=6.068803130576
SVENY15: min=0.781599998474121, max=15.0394, mean=6.24, median=6.106900617568
SVENY16: min=0.817200005054474, max=15.1073, mean=5.86, median=5.2829
SVENY17: min=0.85290002822876, max=15.1716, mean=5.89, median=5.322
SVENY18: min=0.888400018215179, max=15.2318, mean=5.92, median=5.3476
SVENY19: min=0.923600018024445, max=15.2879, mean=5.94, median=5.3714
SVENY20: min=0.958100020885468, max=15.34, mean=5.96, median=5.3917
SVENY21: min=0.991900026798248, max=10.4856, mean=5.29, median=5.0284500415802
SVENY22: min=1.02479994297028, max=10.5206, mean=5.30, median=5.02755
SVENY23: min=1.0566999912262, max=10.5553, mean=5.30, median=5.026400000000001
SVENY24: min=1.08759999275208, max=10.5893, mean=5.31, median=5.01515
SVENY25: min=1.11740005016327, max=10.6217, mean=5.31, median=5.0064
SVENY26: min=1.14619994163513, max=10.6526, mean=5.31, median=4.9976
SVENY27: min=1.17379999160767, max=10.6819, mean=5.30, median=4.979150000000001
SVENY28: min=1.20039999485016, max=10.7099, mean=5.30, median=4.959350000000001
SVENY29: min=1.22580003738403, max=10.7365, mean=5.29, median=4.939100027084351
SVENY30: min=1.2503000497818, max=10.7618, mean=5.28, median=4.9186
```

### Date/Datetime Column Statistics
```
Date: min=1961-06-14 00:00:00, max=2025-09-12 00:00:00
```
...
**Size:** 10.5 MB | **Type:** Parquet | **Shape:** 16,763 rows × 100 columns
...
SVENF21                                  Float64         (40.7% null)
SVENF22                                  Float64         (40.7% null)
SVENF23                                  Float64         (40.7% null)
SVENF24                                  Float64         (40.7% null)
SVENF25                                  Float64         (40.7% null)
SVENF26                                  Float64         (40.7% null)
SVENF27                                  Float64         (40.7% null)
SVENF28                                  Float64         (40.7% null)
SVENF29                                  Float64         (40.7% null)
SVENF30                                  Float64         (40.7% null)
...
SVENPY21                                 Float64         (40.7% null)
SVENPY22                                 Float64         (40.7% null)
SVENPY23                                 Float64         (40.7% null)
SVENPY24                                 Float64         (40.7% null)
SVENPY25                                 Float64         (40.7% null)
SVENPY26                                 Float64         (40.7% null)
SVENPY27                                 Float64         (40.7% null)
SVENPY28                                 Float64         (40.7% null)
SVENPY29                                 Float64         (40.7% null)
SVENPY30                                 Float64         (40.7% null)
SVENY01                                  Float64         (4.4% null)
SVENY02                                  Float64         (4.4% null)
SVENY03                                  Float64         (4.4% null)
SVENY04                                  Float64         (4.4% null)
...
### Numeric Column Statistics
```
BETA0: min=2.22044604947734e-14, max=25.0, mean=5.54, median=4.59684368247225
BETA1: min=-39.7301175575249, max=97.1761487672069, mean=-0.76, median=-1.04829697972622
BETA2: min=-340683.769222452, max=10523.5779721363, mean=-294.82, median=-0.998077992253895
BETA3: min=-10524.6631418207, max=340681.502717697, mean=297.12, median=2.45237133012437
SVEN1F01: min=0.0844999998807907, max=16.5252, mean=5.30, median=5.0471645135804994
SVEN1F04: min=0.435499995946884, max=15.2782, mean=6.02, median=5.736487156417001
SVEN1F09: min=0.853500008583069, max=15.7431, mean=6.79, median=6.572841118028
SVENF01: min=0.0362, max=16.1345, mean=5.03, median=4.89685
SVENF02: min=0.11089999973774, max=15.5119, mean=5.36, median=5.134686599959499
SVENF03: min=0.223700001835823, max=14.8796, mean=5.61, median=5.4179265087205
SVENF04: min=0.363499999046326, max=14.739, mean=5.82, median=5.5941092534145
SVENF05: min=0.505999982357025, max=14.7175, mean=5.99, median=5.7128
SVENF06: min=0.638599991798401, max=14.7341, mean=6.13, median=5.84215
SVENF07: min=0.683600008487701, max=14.7549, mean=6.24, median=5.964787903861
SVENF08: min=0.742299973964691, max=14.785, mean=6.54, median=6.387467457135
SVENF09: min=0.812799990177155, max=15.034, mean=6.62, median=6.4422827389935
SVENF10: min=0.891799986362457, max=15.2763, mean=6.68, median=6.47905
SVENF11: min=0.975899994373322, max=15.4967, mean=6.73, median=6.509467789267
SVENF12: min=1.0621999502182, max=15.6879, mean=6.75, median=6.526
SVENF13: min=1.14810001850128, max=15.8482, mean=6.77, median=6.5278
SVENF14: min=1.23189997673035, max=15.9792, mean=6.77, median=6.5185
SVENF15: min=1.31229996681213, max=16.4299, mean=6.77, median=6.4962
SVENF16: min=1.38839995861053, max=16.8688, mean=6.42, median=6.027596658875
SVENF17: min=1.45959997177124, max=17.2834, mean=6.40, median=5.9881
SVENF18: min=1.52550005912781, max=17.6705, mean=6.37, median=5.930990021876
SVENF19: min=1.58630001544952, max=18.0284, mean=6.34, median=5.867771086846
SVENF20: min=1.6418000459671, max=18.3564, mean=6.31, median=5.7862
SVENF21: min=1.69229996204376, max=11.2878, mean=5.52, median=5.267449961853025
SVENF22: min=1.48959994316101, max=11.3242, mean=5.46, median=5.18764993209839
SVENF23: min=1.28299999237061, max=11.3569, mean=5.41, median=5.11745011482239
SVENF24: min=1.10080003738403, max=11.3862, mean=5.35, median=5.045650036621096
SVENF25: min=0.940999984741211, max=11.4122, mean=5.29, median=4.9542
SVENF26: min=0.801800012588501, max=11.4353, mean=5.24, median=4.8614888169935
SVENF27: min=0.68120002746582, max=11.4556, mean=5.18, median=4.75959493930233
SVENF28: min=0.577099978923798, max=11.4733, mean=5.13, median=4.6571265794345
SVENF29: min=0.48759999871254, max=11.4888, mean=5.07, median=4.569049951553345
SVENF30: min=0.411100000143051, max=11.5023, mean=5.02, median=4.523750118637085
SVENPY01: min=0.0554, max=17.1597, mean=4.90, median=4.928818671385001
SVENPY02: min=0.102, max=16.615, mean=5.09, median=4.94255
SVENPY03: min=0.12720000743866, max=16.2235, mean=5.25, median=5.0089931102055
SVENPY04: min=0.168500006198883, max=16.0286, mean=5.39, median=5.122223816427
SVENPY05: min=0.221599996089935, max=15.8834, mean=5.50, median=5.249659276725
SVENPY06: min=0.280000001192093, max=15.7866, mean=5.60, median=5.3743789532285
SVENPY07: min=0.340099990367889, max=15.7244, mean=5.69, median=5.4637052786049995
SVENPY08: min=0.400099992752075, max=15.6861, mean=5.88, median=5.797997576453
SVENPY09: min=0.458799988031387, max=15.6677, mean=5.95, median=5.860332967231001
SVENPY10: min=0.515900015830994, max=15.6572, mean=6.02, median=5.932876149587
SVENPY11: min=0.571200013160706, max=15.6511, mean=6.07, median=5.962552339044
SVENPY12: min=0.624700009822845, max=15.6474, mean=6.12, median=6.01050254634
SVENPY13: min=0.67629998922348, max=15.6452, mean=6.16, median=6.043108911432
SVENPY14: min=0.726100027561188, max=15.6437, mean=6.20, median=6.060087971733
SVENPY15: min=0.774200022220612, max=15.6427, mean=6.23, median=6.074696176174
SVENPY16: min=0.808300018310547, max=15.642, mean=5.81, median=5.1048
SVENPY17: min=0.841899991035461, max=15.6414, mean=5.83, median=5.144
SVENPY18: min=0.875199973583221, max=15.6409, mean=5.86, median=5.1723
SVENPY19: min=0.907800018787384, max=15.6406, mean=5.87, median=5.1917
SVENPY20: min=0.93970000743866, max=15.6403, mean=5.89, median=5.200809757471
SVENPY21: min=0.970600008964539, max=10.378, mean=5.20, median=4.9289000000000005
SVENPY22: min=1.00049996376038, max=10.3834, mean=5.21, median=4.9333
SVENPY23: min=1.02929997444153, max=10.3881, mean=5.21, median=4.93525
SVENPY24: min=1.05690002441406, max=10.3923, mean=5.22, median=4.9344
SVENPY25: min=1.08340001106262, max=10.3959, mean=5.23, median=4.933350000000001
SVENPY26: min=1.1088000535965, max=10.3992, mean=5.23, median=4.9307
SVENPY27: min=1.13300001621246, max=10.4021, mean=5.23, median=4.923299999999999
SVENPY28: min=1.15600001811981, max=10.4046, mean=5.23, median=4.91445
SVENPY29: min=1.17799997329712, max=10.4069, mean=5.23, median=4.90595
SVENPY30: min=1.19889998435974, max=10.4089, mean=5.23, median=4.8950499999999995
SVENY01: min=0.0554, max=16.462, mean=4.82, median=4.86985
SVENY02: min=0.102, max=15.9118, mean=5.01, median=4.8824
SVENY03: min=0.12720000743866, max=15.5746, mean=5.17, median=4.956488832885
SVENY04: min=0.168500006198883, max=15.3498, mean=5.31, median=5.077718566343499
...
SVENY29: min=1.22580003738403, max=10.7365, mean=5.29, median=4.939100027084351
SVENY30: min=1.2503000497818, max=10.7618, mean=5.28, median=4.9186
TAU1: min=0.100000000000022, max=30.0, mean=2.42, median=1.52808807557868
TAU2: min=-999.99, max=180.858721100232, mean=-281.69, median=4.38476960538511
```
...
**Size:** 9.3 MB | **Type:** Parquet | **Shape:** 186,684 rows × 25 columns
...
maturity                                 Datetime(time_unit='ns', time_zone=None)
coupon                                   Float64        
day_count_basis                          String         
dated_date                               Datetime(time_unit='ns', time_zone=None)
first_interest_date                      Datetime(time_unit='ns', time_zone=None)
last_interest_date                       Datetime(time_unit='ns', time_zone=None)
ncoups                                   Float64        
nextcoup                                 Datetime(time_unit='ns', time_zone=None)
remcoups                                 Float64        
coupacc                                  Float64        
price_eom                                Float64        
tmt                                      Float64        
t_volume                                 Float64         (3.1% null)
t_dvolume                                Float64         (3.1% null)
rating_class                             String         
redcode                                  String         
mat_days                                 Float64        
par_spread                               Float64        
...
### Numeric Column Statistics
```
issue_id: min=54.0, max=1197532.0, mean=399727.15, median=400319.0
principal_amt: min=1000.0, max=1000.0, mean=1000.00, median=1000.0
amount_outstanding: min=112.15, max=9000000.0, mean=665344.16, median=500000.0
coupon: min=0.55, max=13.25, mean=5.69, median=5.75
ncoups: min=2.0, max=12.0, mean=2.01, median=2.0
remcoups: min=2.0, max=120.0, mean=11.07, median=11.0
coupacc: min=0.0, max=6.6431506849315065, mean=1.50, median=1.3315068493150686
price_eom: min=50.0, max=3347.9645670033674, mean=103.80, median=104.11951190476191
tmt: min=1.0138888888888888, max=10.147222222222222, mean=5.32, median=5.2
t_volume: min=1000.0, max=18728526000.0, mean=65334773.85, median=24469000.0
t_dvolume: min=900.0, max=18537484543.17349, mean=66036387.54, median=25179844.913310003
mat_days: min=365.0, max=3650.0, mean=1914.37, median=1870.625
par_spread: min=-0.21835338831352558, max=1.5957769900758496, mean=0.02, median=0.007952520124777214
__index_level_0__: min=5, max=244948, mean=123818.46, median=123803.5
```

### Date/Datetime Column Statistics
```
date: min=2002-07-31 00:00:00, max=2025-04-30 00:00:00
maturity: min=2003-08-15 00:00:00, max=2035-03-15 00:00:00
dated_date: min=1986-04-15 00:00:00, max=2025-03-20 00:00:00
first_interest_date: min=1986-10-15 00:00:00, max=2025-10-15 00:00:00
last_interest_date: min=2003-02-15 00:00:00, max=2034-09-15 00:00:00
nextcoup: min=2002-08-01 00:00:00, max=2025-10-15 00:00:00
```
...
**Size:** 247766 bytes | **Type:** Parquet | **Shape:** 11,213 rows × 5 columns

### Columns
```
redcode                                  String         
ticker                                   String         
obl_cusip                                String          (27.9% null)
isin                                     String         
tier                                     String         
```
...
**Size:** 8.6 MB | **Type:** Parquet | **Shape:** 244,956 rows × 23 columns
...
price_eom                                Float64        
tmt                                      Float64        
t_volume                                 Float64         (3.8% null)
t_dvolume                                Float64         (3.8% null)
rating_class                             String         
redcode                                  String         
mat_days                                 Float64        
```
...
### Numeric Column Statistics
```
issue_id: min=54.0, max=1197532.0, mean=392980.05, median=388297.0
principal_amt: min=1000.0, max=1000.0, mean=1000.00, median=1000.0
amount_outstanding: min=112.15, max=9000000.0, mean=664128.51, median=500000.0
coupon: min=0.55, max=13.25, mean=5.75, median=5.875
ncoups: min=2.0, max=12.0, mean=2.01, median=2.0
remcoups: min=2.0, max=120.0, mean=11.22, median=11.0
coupacc: min=0.0, max=6.6431506849315065, mean=1.51, median=1.35013698630137
price_eom: min=50.0, max=3347.9645670033674, mean=103.76, median=104.119
tmt: min=1.0138888888888888, max=10.147222222222222, mean=5.40, median=5.288888888888889
t_volume: min=1000.0, max=30795864000.0, mean=67589537.44, median=24157000.0
t_dvolume: min=800.0, max=31083850350.194607, mean=68133790.35, median=24898663.189999998
mat_days: min=365.0, max=3650.0, mean=1943.97, median=1903.0694444444443
```

### Date/Datetime Column Statistics
```
date: min=2002-07-31 00:00:00, max=2025-05-31 00:00:00
maturity: min=2003-08-15 00:00:00, max=2035-03-15 00:00:00
dated_date: min=1986-04-15 00:00:00, max=2025-03-20 00:00:00
first_interest_date: min=1986-10-15 00:00:00, max=2025-10-15 00:00:00
last_interest_date: min=2003-02-15 00:00:00, max=2034-09-15 00:00:00
nextcoup: min=2002-08-01 00:00:00, max=2025-11-01 00:00:00
```

---

## cds_basis_aggregated.parquet
**Path:** `/Users/jbejarano/GitRepositories/ftsfr/_data/cds_bond_basis/cds_basis_aggregated.parquet`
**Size:** 27270 bytes | **Type:** Parquet | **Shape:** 790 rows × 10 columns

### Columns
```
c_rating                                 String         
date                                     Datetime(time_unit='ns', time_zone=None)
cds_basis_spread                         Float64        
cds_basis_spread_bps                     Float64        
rfr                                      Float64        
n_bonds                                  Int64          
analysis_period                          String         
period_label                             String         
period_start                             Datetime(time_unit='ms', time_zone=None)
period_end                               Datetime(time_unit='ms', time_zone=None)
```

### Numeric Column Statistics
```
cds_basis_spread: min=-0.03875177840337986, max=0.005759304878255962, mean=-0.01, median=-0.005077361744679458
cds_basis_spread_bps: min=-387.5177840337986, max=57.59304878255962, mean=-63.16, median=-50.773617446794574
rfr: min=-3.8751778403379857, max=0.5759304878255962, mean=-0.63, median=-0.5077361744679457
n_bonds: min=52, max=667, mean=345.42, median=266.5
```

### Date/Datetime Column Statistics
```
date: min=2002-07-31 00:00:00, max=2025-03-31 00:00:00
period_start: min=1900-01-01 00:00:00, max=2010-01-01 00:00:00
period_end: min=2020-02-29 00:00:00, max=2099-12-31 00:00:00
```

---

## cds_basis_non_aggregated.parquet
**Path:** `/Users/jbejarano/GitRepositories/ftsfr/_data/cds_bond_basis/cds_basis_non_aggregated.parquet`
**Size:** 7.3 MB | **Type:** Parquet | **Shape:** 272,882 rows × 10 columns
...
### Numeric Column Statistics
```
cds_basis_spread: min=-0.09996092364237279, max=0.0998565884895731, mean=-0.01, median=-0.004390498359997167
cds_basis_spread_bps: min=-999.6092364237279, max=998.565884895731, mean=-60.36, median=-43.90498359997167
rfr: min=-9.99609236423728, max=9.98565884895731, mean=-0.60, median=-0.43904983599971675
```
...
**Path:** `/Users/jbejarano/GitRepositories/ftsfr/_data/cds_bond_basis/cds_basis_processed.parquet`
**Size:** 18.4 MB | **Type:** Parquet | **Shape:** 185,931 rows × 32 columns
...
par_spread                               Float64        
z_spread                                 Float64        
z_spread_bps                             Float64        
z_model_price                            Float64        
z_status                                 String         
cds_basis_spread                         Float64        
cds_basis_spread_bps                     Float64        
rfr                                      Float64        
...
### Numeric Column Statistics
```
issue_id: min=54.0, max=1197532.0, mean=400372.89, median=400683.0
principal_amt: min=1000.0, max=1000.0, mean=1000.00, median=1000.0
amount_outstanding: min=112.15, max=9000000.0, mean=666120.14, median=500000.0
coupon: min=0.55, max=13.25, mean=5.68, median=5.75
ncoups: min=2.0, max=12.0, mean=2.01, median=2.0
remcoups: min=2.0, max=120.0, mean=11.08, median=11.0
coupacc: min=0.0, max=6.6431506849315065, mean=1.49, median=1.3290410958904109
price_eom: min=50.0, max=159.86533333333333, mean=103.92, median=104.15362511052166
tmt: min=1.0138888888888888, max=10.147222222222222, mean=5.33, median=5.2
t_volume: min=1000.0, max=18728526000.0, mean=65208275.96, median=24450000.0
t_dvolume: min=900.0, max=18537484543.17349, mean=66034914.62, median=25208288.760035
mat_days: min=365.0, max=3650.0, mean=1916.88, median=1870.625
par_spread: min=-0.02966791982851654, max=0.27952275780645713, mean=0.02, median=0.00791411154392868
z_spread: min=-0.0728823100429355, max=0.18997336127511041, mean=0.02, median=0.01377923182459763
z_spread_bps: min=-728.8231004293549, max=1899.7336127511041, mean=216.73, median=137.7923182459763
z_model_price: min=50.22089041088563, max=163.46319634703198, mean=105.42, median=105.6386986301717
cds_basis_spread: min=-0.09996092364237279, max=0.0998565884895731, mean=-0.01, median=-0.004441025002527942
cds_basis_spread_bps: min=-999.6092364237279, max=998.565884895731, mean=-62.44, median=-44.41025002527942
rfr: min=-9.99609236423728, max=9.98565884895731, mean=-0.62, median=-0.4441025002527942
```
...
**Path:** `/Users/jbejarano/GitRepositories/ftsfr/_data/cds_bond_basis/cds_basis_summary_stats.csv`
**Size:** 1102 bytes | **Type:** Csv | **Shape:** 6 rows × 11 columns
...
### Numeric Column Statistics
```
n_obs: min=122, max=274, mean=197.83, median=197.5
mean_bps: min=-87.88312887907333, max=-43.07622307151497, mean=-61.36, median=-56.19612884795198
median_bps: min=-88.74664652091406, max=-42.040734719080206, mean=-55.98, median=-49.5963173883094
std_bps: min=18.170221150048054, max=65.32294185834945, mean=39.57, median=41.23651953197041
```

---

## final_data_with_z_spread.parquet
**Path:** `/Users/jbejarano/GitRepositories/ftsfr/_data/cds_bond_basis/final_data_with_z_spread.parquet`
**Size:** 14.3 MB | **Type:** Parquet | **Shape:** 186,684 rows × 29 columns
...
mat_days                                 Float64        
par_spread                               Float64        
z_spread                                 Float64         (0.2% null)
z_spread_bps                             Float64         (0.2% null)
z_model_price                            Float64         (0.2% null)
z_status                                 String         
__index_level_0__                        Int64          
```
...
mat_days: min=365.0, max=3650.0, mean=1914.37, median=1870.625
par_spread: min=-0.21835338831352558, max=1.5957769900758496, mean=0.02, median=0.007952520124777214
z_spread: min=-0.17947285478152816, max=0.19980038637349926, mean=0.02, median=0.01380365823895746
z_spread_bps: min=-1794.7285478152817, max=1998.0038637349926, mean=218.75, median=138.0365823895746
z_model_price: min=50.22089041088563, max=435.3553410689643, mean=105.37, median=105.62174912704698
__index_level_0__: min=5, max=244948, mean=123818.46, median=123803.5
```
...
**Size:** 10634 bytes | **Type:** Parquet | **Shape:** 546 rows × 3 columns
...
**Size:** 1.9 MB | **Type:** Parquet | **Shape:** 185,931 rows × 3 columns
...
**Size:** 544.3 MB | **Type:** Parquet | **Shape:** 49,845,056 rows × 7 columns
...
### Numeric Column Statistics
```
parspread: min=6.57e-06, max=491.84276269, mean=0.02, median=0.007751308685956962
year: min=2001, max=2025, mean=2012.24, median=2011.0
```

### Date/Datetime Column Statistics
```
date: min=2001-01-02 00:00:00, max=2025-12-31 00:00:00
```
...
**Size:** 503.7 MB | **Type:** Parquet | **Shape:** 38,362,435 rows × 12 columns
...
### Numeric Column Statistics
```
parspread: min=2.001e-05, max=491.84276269, mean=0.02, median=0.007675912252479227
year: min=2001.0, max=2025.0, mean=2011.50, median=2010.0
permno: min=10025, max=93423, mean=53175.27, median=57568.0
permco: min=7, max=60547, mean=21785.81, median=21158.0
nameRatio: min=50, max=100, mean=88.29, median=90.0
__index_level_0__: min=0, max=39851586, mean=19335997.10, median=19215068.0
```
...
**Size:** 545047 bytes | **Type:** Parquet | **Shape:** 4,852 rows × 25 columns
...
shortname                                String         
lei                                      String          (54.9% null)
entity_type                              String         
jurisdiction                             String         
depthlevel                               String          (86.6% null)
markitsector                             String          (0.1% null)
entity_form                              String          (67.5% null)
companynum_type                          String          (84.3% null)
companynum                               String          (84.3% null)
alternativenames                         String          (97.3% null)
recorddate                               String          (62.7% null)
validto                                  String          (57.2% null)
validfrom                                String          (83.2% null)
permno                                   Int64          
permco                                   Int64          
hdrcusip                                 String         
...
### Numeric Column Statistics
```
permno: min=10025, max=93423, mean=62211.02, median=76785.0
permco: min=7, max=60556, mean=25525.04, median=21609.5
nameRatio: min=20, max=100, mean=79.26, median=85.0
```

---

## wrds_bondret_filtered.parquet
**Path:** `/Users/jbejarano/GitRepositories/ftsfr/_data/cds_bond_basis/wrds_bondret_filtered.parquet`
**Size:** 163.6 MB | **Type:** Parquet | **Shape:** 2,497,623 rows × 59 columns
...
issue_id                                 Float64        
cusip                                    String         
bond_sym_id                              String          (0.0% null)
bsym                                     String          (100.0% null)
isin                                     String         
company_symbol                           String          (0.0% null)
bond_type                                String         
security_level                           String         
conv                                     Float64        
offering_date                            Datetime(time_unit='ns', time_zone=None) (0.0% null)
offering_amt                             Float64        
offering_price                           Float64         (8.4% null)
principal_amt                            Float64        
maturity                                 Datetime(time_unit='ns', time_zone=None)
treasury_maturity                        String          (78.0% null)
coupon                                   Float64         (0.0% null)
day_count_basis                          String          (0.1% null)
dated_date                               Datetime(time_unit='ns', time_zone=None) (0.0% null)
first_interest_date                      Datetime(time_unit='ns', time_zone=None) (0.0% null)
last_interest_date                       Datetime(time_unit='ns', time_zone=None)
ncoups                                   Float64        
t_date                                   Datetime(time_unit='ns', time_zone=None)
t_volume                                 Float64         (42.4% null)
t_dvolume                                Float64         (42.4% null)
t_spread                                 Float64         (50.8% null)
t_yld_pt                                 Float64         (53.4% null)
yield                                    Float64         (0.4% null)
amount_outstanding                       Float64        
price_eom                                Float64        
price_ldm                                Float64         (68.7% null)
price_l5m                                Float64         (54.5% null)
gap                                      Float64         (4.9% null)
coupmonth                                Float64         (0.0% null)
nextcoup                                 Datetime(time_unit='ns', time_zone=None) (46.1% null)
coupamt                                  Float64         (0.0% null)
coupacc                                  Float64        
multicoups                               Float64        
ret_eom                                  Float64         (4.9% null)
ret_ldm                                  Float64         (76.3% null)
ret_l5m                                  Float64         (62.1% null)
tmt                                      Float64        
remcoups                                 Float64        
duration                                 Float64         (0.6% null)
r_sp                                     String          (10.0% null)
r_mr                                     String          (37.0% null)
r_fr                                     String          (12.0% null)
n_sp                                     Float64         (57.2% null)
n_mr                                     Float64         (51.6% null)
n_fr                                     Float64         (67.5% null)
rating_num                               Float64         (45.9% null)
rating_cat                               String         
rating_class                             String         
defaulted                                String          (0.2% null)
default_date                             Datetime(time_unit='ns', time_zone=None) (99.0% null)
default_type                             String          (99.0% null)
reinstated                               String          (99.1% null)
reinstated_date                          Datetime(time_unit='ns', time_zone=None) (99.1% null)
year                                     Int64          
```

### Numeric Column Statistics
```
issue_id: min=2.0, max=1211945.0, mean=670824.11, median=697829.0
conv: min=0.0, max=0.0, mean=0.00, median=0.0
offering_amt: min=1.0, max=11000000.0, mean=303617.60, median=14449.0
offering_price: min=0.0, max=8100.0, mean=99.10, median=100.0
principal_amt: min=10.0, max=1000.0, mean=999.65, median=1000.0
coupon: min=0.0, max=31.0, mean=2.78, median=2.0
ncoups: min=0.0, max=12.0, mean=1.17, median=2.0
t_volume: min=0.66, max=58263035000.0, mean=47663006.98, median=11200000.0
t_dvolume: min=0.64912452, max=451940000000.0, mean=48288336.44, median=11516593.91499
t_spread: min=0.0, max=1.9999999625923506, mean=0.00, median=0.002638800927222033
t_yld_pt: min=0.0, max=387414.83453481656, mean=4.97, median=4.101237650330576
yield: min=-2.4346319825548317, max=0.9757631689210376, mean=0.01, median=0.01968926734252144
amount_outstanding: min=101.0, max=11000000.0, mean=293970.46, median=12182.0
price_eom: min=50.0, max=6532.5, mean=110.30, median=100.021875
price_ldm: min=50.0, max=6532.5, mean=102.23, median=101.68400174825175
price_l5m: min=50.0, max=6532.5, mean=103.95, median=102.03643277310924
gap: min=1.0, max=1.0, mean=1.00, median=1.0
coupmonth: min=-1.0, max=1134.0, mean=35.59, median=19.0
coupamt: min=0.0, max=12.0, mean=0.22, median=0.0
coupacc: min=0.0, max=20.4, mean=0.70, median=0.1534246575342466
multicoups: min=1.0, max=1.0, mean=1.00, median=1.0
ret_eom: min=-0.9854726368159205, max=154.1496466867339, mean=0.01, median=0.0
ret_ldm: min=-0.9854726368159205, max=100.9697964543664, mean=0.00, median=0.0032104524894270604
ret_l5m: min=-0.9854726368159205, max=100.9697964543664, mean=0.00, median=0.0033266223406132438
tmt: min=1.0138888888888888, max=10.147222222222222, mean=4.04, median=3.55
remcoups: min=1.0, max=120.0, mean=6.31, median=3.0
duration: min=0.4805505628438583, max=261.4938874340617, mean=3.65, median=3.38240296983532
n_sp: min=1.0, max=22.0, mean=8.42, median=8.0
n_mr: min=1.0, max=21.0, mean=8.17, median=8.0
n_fr: min=1.0, max=22.0, mean=7.92, median=8.0
rating_num: min=1.0, max=22.0, mean=8.15, median=8.0
year: min=2002, max=2025, mean=2017.11, median=2019.0
```

### Date/Datetime Column Statistics
```
date: min=2002-07-31 00:00:00, max=2025-05-31 00:00:00
offering_date: min=1930-03-01 00:00:00, max=2030-03-15 00:00:00
maturity: min=2003-08-01 00:00:00, max=2035-03-31 00:00:00
dated_date: min=1930-03-01 00:00:00, max=2025-12-03 00:00:00
first_interest_date: min=1930-09-01 00:00:00, max=2030-03-15 00:00:00
last_interest_date: min=2000-05-15 00:00:00, max=2035-03-30 00:00:00
t_date: min=2002-07-01 00:00:00, max=2025-03-31 00:00:00
nextcoup: min=2002-08-01 00:00:00, max=2026-07-28 00:00:00
default_date: min=2002-09-03 00:00:00, max=2023-10-15 00:00:00
reinstated_date: min=2003-02-10 00:00:00, max=2024-11-07 00:00:00
```

---

## wrds_bondret_project.parquet
**Path:** `/Users/jbejarano/GitRepositories/ftsfr/_data/cds_bond_basis/wrds_bondret_project.parquet`
**Size:** 77.2 MB | **Type:** Parquet | **Shape:** 2,496,531 rows × 21 columns
...
### Numeric Column Statistics
```
issue_id: min=2.0, max=1211945.0, mean=670792.24, median=697800.0
principal_amt: min=10.0, max=1000.0, mean=999.65, median=1000.0
amount_outstanding: min=101.0, max=11000000.0, mean=294097.72, median=12215.0
coupon: min=0.0, max=31.0, mean=2.78, median=2.0
ncoups: min=0.0, max=12.0, mean=1.17, median=2.0
remcoups: min=1.0, max=120.0, mean=6.31, median=3.0
coupacc: min=0.0, max=20.4, mean=0.70, median=0.1541095890410959
price_eom: min=50.0, max=6532.5, mean=110.30, median=100.02302025276242
tmt: min=1.0138888888888888, max=10.147222222222222, mean=4.04, median=3.55
t_volume: min=0.66, max=58263035000.0, mean=47671518.95, median=11205000.0
t_dvolume: min=0.64912452, max=451940000000.0, mean=48296967.11, median=11522910.137545
```
...
**Size:** 123058 bytes | **Type:** Parquet | **Shape:** 6,449 rows × 7 columns
...
### Numeric Column Statistics
```
DGS1MO: min=0.0, max=6.02, mean=1.64, median=0.96
DGS3MO: min=0.0, max=5.87, mean=1.76, median=1.09
DGS6MO: min=0.02, max=5.61, mean=1.85, median=1.2
DGS1: min=0.04, max=5.49, mean=1.92, median=1.4
DGS2: min=0.09, max=5.29, mean=2.08, median=1.68
DGS3: min=0.1, max=5.26, mean=2.26, median=1.95
```

### Date/Datetime Column Statistics
```
DATE: min=2001-01-01 00:00:00, max=2025-09-18 00:00:00
```
...
**Size:** 93748 bytes | **Type:** Parquet | **Shape:** 5,510 rows × 4 columns
...
monthly_return: min=-1.805303277625713, max=1.2258522666583374, mean=nan, median=nan
```
...
**Size:** 49968 bytes | **Type:** Parquet | **Shape:** 276 rows × 21 columns
...
### Numeric Column Statistics
```
3Y_Q1: min=5.3628018753738094e-05, max=0.0012976019246790454, mean=0.00, median=0.00017811644203234722
3Y_Q2: min=9.792364591956705e-05, max=0.0017565444327524377, mean=0.00, median=0.0003000888658549769
3Y_Q3: min=0.00016917468922001774, max=0.002839619979664215, mean=0.00, median=0.000484598295193228
3Y_Q4: min=0.0003547310256768793, max=0.008639688887694464, mean=0.00, median=0.0008267025348825121
3Y_Q5: min=0.0010307910642681614, max=0.017051896883679123, mean=0.00, median=0.003330822431457334
5Y_Q1: min=8.240990262731174e-05, max=0.0013420012384308677, mean=0.00, median=0.0002784942276486957
5Y_Q2: min=0.00016566343952595375, max=0.0015301593893626286, mean=0.00, median=0.000500869889554445
5Y_Q3: min=0.00024425347777401457, max=0.0029896231885115916, mean=0.00, median=0.000756561528841848
5Y_Q4: min=0.0006774992502349697, max=0.008650813007283542, mean=0.00, median=0.0013598748822090112
5Y_Q5: min=0.0018238025721322164, max=0.018314903765577432, mean=0.01, median=0.004580733021791073
7Y_Q1: min=0.00010965437792720459, max=0.0013947385975646358, mean=0.00, median=0.0003602111417185893
7Y_Q2: min=8.18284819000086e-05, max=0.0015355974906025656, mean=0.00, median=0.0006680118012768208
7Y_Q3: min=0.0001235526833699167, max=0.0030815775765088028, mean=0.00, median=0.00099634229016757
7Y_Q4: min=0.0011028616018917818, max=0.007196432728034767, mean=0.00, median=0.0020621264410935185
7Y_Q5: min=0.0024402150265846485, max=0.01900555548556001, mean=0.01, median=0.005423041140361075
10Y_Q1: min=0.00013487699044364043, max=0.0009053721002913167, mean=0.00, median=0.00048195955674491846
10Y_Q2: min=7.057998212511712e-05, max=0.001505258169825882, mean=0.00, median=0.0007536285575015698
10Y_Q3: min=0.0001407322027343715, max=0.003152209196248978, mean=0.00, median=0.0011659759869156094
10Y_Q4: min=0.0013641252839577797, max=0.007450563709574988, mean=0.00, median=0.002308584939926143
10Y_Q5: min=0.003044597665108594, max=0.019341884154433435, mean=0.01, median=0.006119310424822318
```
...
**Size:** 22796 bytes | **Type:** Parquet | **Shape:** 269 rows × 11 columns
...
### Numeric Column Statistics
```
1.0: min=-0.03987445309758186, max=0.08856474608182907, mean=0.00, median=0.002646580571308732
2.0: min=-0.039339255541563034, max=0.11926195025444031, mean=0.00, median=0.003365177195519209
3.0: min=-0.044883377850055695, max=0.10892783105373383, mean=0.00, median=0.005076491739600897
4.0: min=-0.05933888256549835, max=0.10600525140762329, mean=0.00, median=0.005577133037149906
5.0: min=-0.06916289776563644, max=0.08564526587724686, mean=0.00, median=0.006313825957477093
6.0: min=-0.07552362978458405, max=0.0815199539065361, mean=0.01, median=0.007862609811127186
7.0: min=-0.07491669803857803, max=0.0782635286450386, mean=0.01, median=0.007974319159984589
8.0: min=-0.10312984883785248, max=0.10433915257453918, mean=0.01, median=0.007327876053750515
9.0: min=-0.1837763488292694, max=0.3147818148136139, mean=0.01, median=0.007759173400700092
10.0: min=-0.29776981472969055, max=0.2588067650794983, mean=0.01, median=0.008154206909239292
```

### Date/Datetime Column Statistics
```
date: min=2002-08-31 00:00:00, max=2024-12-31 00:00:00
```
...
**Size:** 22372 bytes | **Type:** Parquet | **Shape:** 2,690 rows × 3 columns
...
**Size:** 9.6 MB | **Type:** Parquet | **Shape:** 1,859,498 rows × 3 columns
...
**Size:** 36.8 MB | **Type:** Parquet | **Shape:** 2,381,340 rows × 5 columns
...
**Size:** 5.0 MB | **Type:** Parquet | **Shape:** 374,312 rows × 4 columns
...
**Size:** 958727 bytes | **Type:** Parquet | **Shape:** 52,473 rows × 4 columns
...
**Size:** 14027 bytes | **Type:** Parquet | **Shape:** 1,032 rows × 3 columns
...
**Size:** 146494 bytes | **Type:** Parquet | **Shape:** 9,531 rows × 3 columns
...
**Size:** 16732 bytes | **Type:** Parquet | **Shape:** 1,174 rows × 3 columns
...
**Size:** 114101 bytes | **Type:** Parquet | **Shape:** 15,552 rows × 3 columns
...
### Numeric Column Statistics
```
return: min=-0.4527408759578536, max=1.546129568151272, mean=-0.01, median=0.0
```
...
**Size:** 85950 bytes | **Type:** Parquet | **Shape:** 15,552 rows × 3 columns
...
**Size:** 37374 bytes | **Type:** Parquet | **Shape:** 5,184 rows × 3 columns
...
**Size:** 48853 bytes | **Type:** Parquet | **Shape:** 5,184 rows × 3 columns
...
### Numeric Column Statistics
```
return: min=-0.4007418311074428, max=0.8153642585692351, mean=-0.01, median=-0.0010693203501211206
```
...
**Size:** 97.2 MB | **Type:** Parquet | **Shape:** 2,559,674 rows × 23 columns
...
### Numeric Column Statistics
```
kytreasno: min=200636.0, max=208559.0, mean=204616.77, median=204063.0
tdbid: min=43.5, max=176.328125, mean=104.23, median=100.87890619999999
tdask: min=43.546875, max=176.390625, mean=104.31, median=100.9375
tdaccint: min=0.0, max=11.86908390823, mean=1.33, median=0.90421195652174
tdyld: min=-0.016641617296462, max=0.0065577934599587, mean=0.00, median=0.000114636933176755
price: min=44.05672554347826, max=182.7192679558011, mean=105.60, median=102.2386675824176
tdpubout: min=1.0, max=120001.0, mean=20405.02, median=15005.0
tdtotout: min=4.0, max=148501.0, mean=25547.93, median=19798.0
tdpdint: min=0.0, max=11.913043478261, mean=0.02, median=0.0
tcouprt: min=0.125, max=16.25, mean=5.35, median=4.75
itype: min=1.0, max=2.0, mean=1.75, median=2.0
original_maturity: min=1.0, max=40.0, mean=11.07, median=7.0
years_to_maturity: min=0.0, max=30.0, mean=6.24, median=3.0
tdduratn: min=-1.0, max=9160.066986023601, mean=1663.23, median=1115.9104028816
tdretnua: min=-0.10941117224377, max=0.12811078405138, mean=0.00, median=0.00014439069901748
days_to_maturity: min=1, max=11053, mean=2277.19, median=1215.0
```

### Date/Datetime Column Statistics
```
caldt: min=1970-01-02 00:00:00, max=2026-04-30 00:00:00
tdatdt: min=1955-02-15 00:00:00, max=2026-04-30 00:00:00
tmatdt: min=1970-02-15 00:00:00, max=2056-02-15 00:00:00
...
**Size:** 123.3 MB | **Type:** Parquet | **Shape:** 3,183,517 rows × 14 columns
...
**Size:** 80696 bytes | **Type:** Parquet | **Shape:** 2,282 rows × 8 columns
...
### Numeric Column Statistics
```
kytreasno: min=200018.0, max=208559.0, mean=204638.55, median=204036.5
tcouprt: min=0.125, max=16.25, mean=4.61, median=4.0
itype: min=1.0, max=2.0, mean=1.91, median=2.0
original_maturity: min=1.0, max=40.0, mean=6.07, median=5.0
```

### Date/Datetime Column Statistics
```
tdatdt: min=1916-01-01 00:00:00, max=2026-04-30 00:00:00
tmatdt: min=1926-03-15 00:00:00, max=2056-02-15 00:00:00
```

---

## CRSP_TFZ_consolidated_all_itypes.parquet
**Path:** `/Users/jbejarano/GitRepositories/ftsfr/_data/us_treasury_returns/CRSP_TFZ_consolidated_all_itypes.parquet`
**Size:** 116.2 MB | **Type:** Parquet | **Shape:** 3,063,408 rows × 23 columns
...
tdyld                                    Float64         (0.0% null)
price                                    Float64         (0.0% null)
tdpubout                                 Float64         (18.4% null)
tdtotout                                 Float64         (2.3% null)
tdpdint                                  Float64        
tcouprt                                  Float64        
itype                                    Float64        
original_maturity                        Float64        
...
### Numeric Column Statistics
```
kytreasno: min=200629.0, max=208559.0, mean=204505.40, median=204045.0
tdbid: min=43.5, max=176.328125, mean=103.28, median=100.13671875
tdask: min=43.546875, max=176.390625, mean=103.35, median=100.1875
tdaccint: min=0.0, max=11.86908390823, mean=1.11, median=0.65247252747253
tdyld: min=-0.016641617296462, max=0.0065577934599587, mean=0.00, median=0.000116403958569855
price: min=44.05672554347826, max=182.7192679558011, mean=104.43, median=101.09777424061453
tdpubout: min=1.0, max=120001.0, mean=20405.02, median=15005.0
tdtotout: min=4.0, max=313912.0, mean=26715.50, median=20086.0
tdpdint: min=0.0, max=11.913043478261, mean=0.02, median=0.0
tcouprt: min=0.0, max=16.25, mean=4.47, median=3.75
itype: min=1.0, max=4.0, mean=2.12, median=2.0
original_maturity: min=0.0, max=40.0, mean=9.31, median=5.0
years_to_maturity: min=0.0, max=30.0, mean=5.24, median=2.0
tdduratn: min=-1.0, max=9160.066986023601, mean=1409.63, median=841.59329381127
tdretnua: min=-0.10941117224377, max=0.12811078405138, mean=0.00, median=0.00013590322677276
days_to_maturity: min=1, max=11053, mean=1922.64, median=893.0
```

### Date/Datetime Column Statistics
```
caldt: min=1970-01-02 00:00:00, max=2026-04-30 00:00:00
tdatdt: min=1955-02-15 00:00:00, max=2026-05-07 00:00:00
tmatdt: min=1970-01-08 00:00:00, max=2056-02-15 00:00:00
tfcaldt: min=1970-01-01 00:00:00, max=1970-01-01 00:00:00
```
...
**Size:** 97.3 MB | **Type:** Parquet | **Shape:** 2,559,674 rows × 24 columns
...
tdretnua: min=-0.10941117224377, max=0.12811078405138, mean=0.00, median=0.00014439069901748
days_to_maturity: min=1, max=11053, mean=2277.19, median=1215.0
run: min=0, max=84, mean=19.32, median=14.0
```
...
## CRSP_TFZ_with_runness_all_itypes.parquet
**Path:** `/Users/jbejarano/GitRepositories/ftsfr/_data/us_treasury_returns/CRSP_TFZ_with_runness_all_itypes.parquet`
**Size:** 116.4 MB | **Type:** Parquet | **Shape:** 3,063,408 rows × 24 columns
...
tdretnua: min=-0.10941117224377, max=0.12811078405138, mean=0.00, median=0.00013590322677276
days_to_maturity: min=1, max=11053, mean=1922.64, median=893.0
run: min=0, max=84, mean=17.50, median=12.0
```
...
**Size:** 78255 bytes | **Type:** Parquet | **Shape:** 6,659 rows × 3 columns
...
**Size:** 1.2 MB | **Type:** Parquet | **Shape:** 121,827 rows × 3 columns
...
**Size:** 28734 bytes | **Type:** Parquet | **Shape:** 1,017 rows × 3 columns
...
### Numeric Column Statistics
```
totalTendered: min=72950000.0, max=566665759500.0, mean=139581709139.43, median=78753758000.0
totalAccepted: min=25000100.0, max=255492688300.0, mean=56974628899.31, median=34767473000.0
```

### Date/Datetime Column Statistics
```
issueDate: min=1979-11-15 00:00:00, max=2025-09-30 00:00:00
```
...
**Size:** 1.2 MB | **Type:** Parquet | **Shape:** 2,449,794 rows × 5 columns
...
### Numeric Column Statistics
```
run: min=0, max=84, mean=21.46, median=17.0
```

### Date/Datetime Column Statistics
```
date: min=1979-11-15 00:00:00, max=2025-09-19 00:00:00
```
...
**Size:** 2.0 MB | **Type:** Parquet | **Shape:** 10,982 rows × 120 columns
...
accruedInterestPer1000                   Float64         (85.0% null)
...
averageMedianInvestmentRate              Float64         (78.5% null)
averageMedianPrice                       Float64         (55.6% null)
averageMedianDiscountMargin              String         
averageMedianYield                       String         
backDated                                Null            (100.0% null)
backDatedDate                            Datetime(time_unit='ns', time_zone=None) (91.0% null)
bidToCoverRatio                          Float64         (29.3% null)
...
lowYield                                 String         
maturingDate                             Datetime(time_unit='ns', time_zone=None) (26.2% null)
...
originalDatedDate                        Datetime(time_unit='ns', time_zone=None) (94.7% null)
originalIssueDate                        Datetime(time_unit='ns', time_zone=None) (31.5% null)
...
tintCusip1                               String         
tintCusip2                               String         
tintCusip1DueDate                        Datetime(time_unit='ns', time_zone=None) (99.6% null)
tintCusip2DueDate                        Datetime(time_unit='ns', time_zone=None) (100.0% null)
```

### Numeric Column Statistics
```
interestRate: min=0.125, max=16.25, mean=4.10, median=3.375
accruedInterestPer1000: min=0.0, max=36.72798, mean=1.54, median=0.01374
accruedInterestPer100: min=0.000250021, max=0.940779263, mean=0.21, median=0.088379605
adjustedAccruedInterestPer1000: min=0.0, max=9.15983, mean=1.44, median=0.49716499999999997
adjustedPrice: min=81.754227, max=132.953297, mean=101.45, median=100.004056
allocationPercentage: min=0.01, max=100.0, mean=49.67, median=49.765
averageMedianDiscountRate: min=0.0, max=18.48, mean=3.48, median=3.33
...
bidToCoverRatio: min=1.11, max=10.72, mean=3.07, median=2.91
totalAccepted: min=25000000.0, max=110357985100.0, mean=28725959551.95, median=24001125900.0
totalTendered: min=72950000.0, max=321826290000.0, mean=84408771620.68, median=62277908250.0
```

### Date/Datetime Column Statistics
```
issueDate: min=1979-11-15 00:00:00, max=2026-06-01 00:00:00
maturityDate: min=1980-04-03 00:00:00, max=2056-05-15 00:00:00
announcementDate: min=1979-10-24 00:00:00, max=2026-05-21 00:00:00
auctionDate: min=1979-10-31 00:00:00, max=2026-05-28 00:00:00
datedDate: min=1979-11-15 00:00:00, max=2026-05-31 00:00:00
backDatedDate: min=2008-01-15 00:00:00, max=2026-05-31 00:00:00
callDate: min=2004-11-15 00:00:00, max=2009-11-15 00:00:00
calledDate: min=2004-11-15 00:00:00, max=2009-11-15 00:00:00
firstInterestPaymentDate: min=1980-05-15 00:00:00, max=2026-11-30 00:00:00
maturingDate: min=1996-02-15 00:00:00, max=2026-05-31 00:00:00
originalDatedDate: min=2005-02-15 00:00:00, max=2026-04-30 00:00:00
originalIssueDate: min=1979-01-18 00:00:00, max=2026-04-30 00:00:00
tintCusip1DueDate: min=2027-12-15 00:00:00, max=2056-05-15 00:00:00
tintCusip2DueDate: min=2055-02-15 00:00:00, max=2056-02-15 00:00:00
```
...
**Size:** 588.7 MB | **Type:** Parquet | **Shape:** 33,620,169 rows × 9 columns
...
**Size:** 55914 bytes | **Type:** Parquet | **Shape:** 1,495 rows × 6 columns
...
### Numeric Column Statistics
```
rssd9001: min=31303.0, max=5860236.0, mean=2061862.82, median=1493560.0
permco: min=21.0, max=59945.0, mean=23894.67, median=15150.0
```
...
**Size:** 806.1 MB | **Type:** Parquet | **Shape:** 2,002,806 rows × 373 columns

### Columns
```
rssd9001                                 Float64        
rcon9804                                 Int64           (8.2% null)
date                                     Datetime(time_unit='ns', time_zone=None)
rssdsubmissiondate                       Datetime(time_unit='ns', time_zone=None) (68.5% null)
rssd9050                                 Float64         (0.1% null)
rssd9055                                 Float64         (0.1% null)
rssd9048                                 Int64           (10.1% null)
assets                                   Float64         (0.2% null)
cash                                     Float64         (0.5% null)
securities                               Float64         (2.2% null)
...
avgirate_timedep                         Float64         (63.2% null)
avgirate_timedep_ytd                     Float64         (38.4% null)
avgirate_savdep                          Float64         (69.2% null)
avgirate_fordep                          Float64         (99.1% null)
...
### Numeric Column Statistics
```
rssd9001: min=28.0, max=5887420.0, mean=708006.97, median=573009.0
rcon9804: min=0, max=59, mean=40.11, median=51.0
rssd9050: min=0.0, max=91398.0, mean=16015.14, median=14420.0
rssd9055: min=0.0, max=718184.0, mean=9597.95, median=0.0
rssd9048: min=0, max=720, mean=199.96, median=200.0
...
avgirate_timedep: min=-3.9245, max=30.5556, mean=0.03, median=0.0262
avgirate_timedep_ytd: min=-0.6851, max=944.5333, mean=0.04, median=0.0432
avgirate_savdep: min=-2.8889, max=45.5, mean=0.01, median=0.0071
avgirate_fordep: min=-1.0432, max=677.7143, mean=0.12, median=0.0511
...
**Size:** 247.9 MB | **Type:** Parquet | **Shape:** 12,623,400 rows × 12 columns

### Columns
```
reln_year                                Int64          
focal_rssd_id                            Float64        
focal_name                               String          (0.2% null)
position                                 Int64          
immediate_rssd_id                        Float64        
immediate_name                           String          (0.2% null)
primary_flag                             Int64          
ultimate_rssd_id                         Float64        
...
### Numeric Column Statistics
```
reln_year: min=1923, max=2025, mean=2008.44, median=2010.0
focal_rssd_id: min=28.0, max=6075046.0, mean=2962059.58, median=3134643.0
position: min=0, max=31, mean=3.66, median=3.0
immediate_rssd_id: min=130.0, max=6074562.0, mean=2739243.88, median=2937940.0
primary_flag: min=0, max=1, mean=0.64, median=1.0
ultimate_rssd_id: min=868.0, max=6050100.0, mean=1967030.23, median=1647970.0
recursive_flag: min=0, max=1, mean=0.02, median=0.0
__index_level_0__: min=0, max=499999, mean=248158.77, median=247531.5
```
...
**Size:** 99.1 MB | **Type:** Parquet | **Shape:** 5,117,080 rows × 17 columns
...
shrout: min=1, max=29206400, mean=48419.85, median=8500.0
...
**Size:** 11.0 MB | **Type:** Parquet | **Shape:** 578,694 rows × 10 columns
...
### Numeric Column Statistics
```
at: min=0.0, max=4349731.0, mean=6123.93, median=112.8
pstkl: min=-0.421, max=526300.0, mean=35.58, median=0.0
txditc: min=-285.769, max=92344.0, mean=112.08, median=0.0
pstkrv: min=-67.0, max=526300.0, mean=36.63, median=0.0
seq: min=-86154.0, max=649368.0, mean=1062.40, median=43.6165
pstk: min=-252.0, max=139966.0, mean=30.69, median=0.0
year: min=1959, max=2025, mean=1998.43, median=1999.0
__index_level_0__: min=0, max=499999, mean=221353.74, median=210652.5
```

### Date/Datetime Column Statistics
```
datadate: min=1959-01-31 00:00:00, max=2025-08-31 00:00:00
```
...
**Size:** 48775 bytes | **Type:** Parquet | **Shape:** 1,188 rows × 9 columns
...
**Size:** 21.7 MB | **Type:** Parquet | **Shape:** 3,810,519 rows × 3 columns
...
**Size:** 18.4 MB | **Type:** Parquet | **Shape:** 3,810,519 rows × 3 columns
...
**Size:** 5461 bytes | **Type:** Csv | **Shape:** 35 rows × 4 columns
...
### Numeric Column Statistics
```
seasonality: min=1, max=12, mean=2.71, median=1.0
```

---

## tips_treasury_summary.csv
**Path:** `/Users/jbejarano/GitRepositories/ftsfr/_output/tips_treasury_summary.csv`
**Size:** 283 bytes | **Type:** Csv | **Shape:** 9 rows × 5 columns

### Columns
```
                                         String         
TIPS-Treasury 2Y                         String         
TIPS-Treasury 5Y                         String         
TIPS-Treasury 10Y                        String         
TIPS-Treasury 20Y                        String         
```