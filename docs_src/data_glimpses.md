...
### Numeric Column Statistics
```
3Y_Q1: min=-0.010195486289675806, max=0.006800799482253159, mean=0.00, median=0.00011093757411258774
3Y_Q2: min=-0.01986653721216269, max=0.00868190404065121, mean=0.00, median=0.00015819982568439416
3Y_Q3: min=-0.021733188826281554, max=0.02643235787920688, mean=0.00, median=0.0003204922698186298
3Y_Q4: min=-0.04722684328193269, max=0.05832620992874829, mean=0.00, median=0.00044605430682066846
3Y_Q5: min=-0.048165104823452064, max=0.07523401578532865, mean=0.00, median=0.0026030491358693744
5Y_Q1: min=-0.008974482093833225, max=0.005868058456800718, mean=0.00, median=0.00015137177841173521
5Y_Q2: min=-0.01602387252124604, max=0.00861865369555459, mean=0.00, median=0.0002865354128779307
5Y_Q3: min=-0.02493821094246429, max=0.026735575767586894, mean=0.00, median=0.0004929738982502041
5Y_Q4: min=-0.043155226084542586, max=0.06177358729105742, mean=0.00, median=0.0009126513937399716
5Y_Q5: min=-0.051220475985288894, max=0.07691366861120197, mean=0.00, median=0.0031747391803118585
7Y_Q1: min=-0.009791017351203152, max=0.005362864490588132, mean=0.00, median=0.00026490052986478376
7Y_Q2: min=-0.01080200743244012, max=0.00964583172128868, mean=0.00, median=0.0004962352742699169
7Y_Q3: min=-0.026816284839296496, max=0.026335246100046478, mean=0.00, median=0.0006790812059342453
7Y_Q4: min=-0.04551113870332973, max=0.066096125715074, mean=0.00, median=0.001182791417233751
7Y_Q5: min=-0.04530191808904948, max=0.07198967094605183, mean=0.00, median=0.0037068821442877873
10Y_Q1: min=-0.00992481328608734, max=0.005188143653633713, mean=0.00, median=0.00032367955714532597
10Y_Q2: min=-0.010893580778431809, max=0.009033157383129526, mean=0.00, median=0.0006090137256567295
10Y_Q3: min=-0.02779200007523279, max=0.026253008069101354, mean=0.00, median=0.0007285959360442323
10Y_Q4: min=-0.04496679490789988, max=0.0672449736197277, mean=0.00, median=0.001393925995218339
10Y_Q5: min=-0.04772250818239048, max=0.07142640500748478, mean=0.01, median=0.003932033340702757
```
...
**Size:** 39854 bytes | **Type:** Csv | **Shape:** 1,011 rows × 3 columns
...
**Size:** 83.5 MB | **Type:** Csv | **Shape:** 2,425,482 rows × 5 columns
