...
### Date/Datetime Column Statistics
```
recorddate: min=2002-01-08, max=2025-06-04
validto: min=1995-06-28, max=2025-05-06
...
### Date/Datetime Column Statistics
```
Date: min=1961-06-14 00:00:00, max=2025-06-06 00:00:00
```
...
### Date/Datetime Column Statistics
```
DATE: min=2001-01-01 00:00:00, max=2025-06-13 00:00:00
```
...
**Size:** 18.5 MB | **Type:** Parquet | **Shape:** 4,940,039 rows × 5 columns
...
### Numeric Column Statistics
```
futcode: min=37.0, max=488756.0, mean=204898.10, median=181611.0
settlement: min=-37.630005, max=24480.0, mean=596.85, median=59.729996
product_code: min=289, max=3847, mean=2122.23, median=2060.0
```

### Date/Datetime Column Statistics
```
date: min=1973-01-02 00:00:00, max=2025-07-16 00:00:00
```
...
**Size:** 1.2 MB | **Type:** Parquet | **Shape:** 26,003 rows × 26 columns
...
### Date/Datetime Column Statistics
```
date: min=1926-07-01 00:00:00, max=2025-05-30 00:00:00
```
...
**Size:** 751927 bytes | **Type:** Parquet | **Shape:** 15,583 rows × 26 columns
...
### Date/Datetime Column Statistics
```
date: min=1963-07-01 00:00:00, max=2025-05-30 00:00:00
```
...
**Size:** 753070 bytes | **Type:** Parquet | **Shape:** 15,583 rows × 26 columns
...
ME3 OP5: min=-0.1461, max=0.1292, mean=0.00, median=0.0009
...
**Size:** 304732 bytes | **Type:** Parquet | **Shape:** 1,187 rows × 26 columns
...
### Numeric Column Statistics
```
SMALL LoBM: min=-0.49472900000000003, max=1.478401, mean=0.01, median=0.008067
ME1 BM2: min=-0.352371, max=1.2604680000000001, mean=0.01, median=0.007157
...
BIG LoBM: min=-0.284528, max=0.324293, mean=0.01, median=0.011575
...
### Date/Datetime Column Statistics
```
date: min=1926-07-01 00:00:00, max=2025-05-01 00:00:00
```
...
**Size:** 194370 bytes | **Type:** Parquet | **Shape:** 743 rows × 26 columns
...
SMALL HiINV: min=-0.32182499999999997, max=0.312182, mean=0.01, median=0.008109
...
BIG HiINV: min=-0.22681, max=0.23310199999999998, mean=0.01, median=0.012119999999999999
```

### Date/Datetime Column Statistics
```
date: min=1963-07-01 00:00:00, max=2025-05-01 00:00:00
```
...
**Size:** 194133 bytes | **Type:** Parquet | **Shape:** 743 rows × 26 columns
...
BIG LoOP: min=-0.275389, max=0.219619, mean=0.01, median=0.009932
...
**Size:** 93.7 MB | **Type:** Parquet | **Shape:** 2,479,718 rows × 23 columns
...
### Numeric Column Statistics
```
kytreasno: min=200636.0, max=208405.0, mean=204519.67, median=204053.0
tdbid: min=43.5, max=176.328125, mean=104.54, median=100.98828125
tdask: min=43.546875, max=176.390625, mean=104.63, median=101.046875
tdaccint: min=0.0, max=11.86908390823, mean=1.35, median=0.91367403314917
tdyld: min=-0.016641617296462, max=0.0065577934599587, mean=0.00, median=0.00011586292052366
price: min=44.05672554347826, max=182.7192679558011, mean=105.93, median=102.37141393442622
tdpubout: min=1.0, max=120001.0, mean=19483.81, median=14420.0
tdtotout: min=4.0, max=148501.0, mean=24460.78, median=18824.0
...
tdduratn: min=-1.0, max=9160.066986023601, mean=1649.23, median=1110.5170192089001
tdretnua: min=-0.10941117224377, max=0.12811078405138, mean=0.00, median=0.000144551547236295
days_to_maturity: min=1, max=11053, mean=2261.29, median=1210.0
```

### Date/Datetime Column Statistics
```
caldt: min=1970-01-02 00:00:00, max=2025-05-30 00:00:00
tdatdt: min=1955-02-15 00:00:00, max=2025-05-31 00:00:00
...
**Size:** 79067 bytes | **Type:** Parquet | **Shape:** 2,229 rows × 8 columns
...
### Numeric Column Statistics
```
kytreasno: min=200018.0, max=208405.0, mean=204547.10, median=204008.0
tcouprt: min=0.125, max=16.25, mean=4.63, median=4.0
itype: min=1.0, max=2.0, mean=1.91, median=2.0
original_maturity: min=1.0, max=40.0, mean=6.05, median=5.0
```

### Date/Datetime Column Statistics
```
tdatdt: min=1916-01-01 00:00:00, max=2025-05-31 00:00:00
...
**Size:** 93.8 MB | **Type:** Parquet | **Shape:** 2,479,718 rows × 24 columns
...
tdretnua: min=-0.10941117224377, max=0.12811078405138, mean=0.00, median=0.000144551547236295
days_to_maturity: min=1, max=11053, mean=2261.29, median=1210.0
run: min=0, max=84, mean=18.98, median=14.0
```
...
**Size:** 1.9 MB | **Type:** Parquet | **Shape:** 10,611 rows × 120 columns
...
averageMedianPrice                       Float64         (54.0% null)
...
adjustedPrice: min=81.754227, max=132.953297, mean=101.54, median=100.067766
allocationPercentage: min=0.01, max=100.0, mean=49.66, median=49.68
...
totalAccepted: min=25000000.0, max=95686476000.0, mean=27162444644.90, median=24000009100.0
totalTendered: min=72950000.0, max=287396859400.0, mean=80168265776.28, median=58554929000.0
```

### Date/Datetime Column Statistics
```
issueDate: min=1979-11-15 00:00:00, max=2025-07-31 00:00:00
maturityDate: min=1980-04-03 00:00:00, max=2055-05-15 00:00:00
announcementDate: min=1979-10-24 00:00:00, max=2025-07-17 00:00:00
auctionDate: min=1979-10-31 00:00:00, max=2025-07-24 00:00:00
datedDate: min=1979-11-15 00:00:00, max=2025-07-15 00:00:00
...
firstInterestPaymentDate: min=1980-05-15 00:00:00, max=2026-01-15 00:00:00
maturingDate: min=1996-02-15 00:00:00, max=2025-07-31 00:00:00
originalDatedDate: min=2005-02-15 00:00:00, max=2025-05-15 00:00:00
originalIssueDate: min=1979-01-18 00:00:00, max=2025-06-02 00:00:00
tintCusip1DueDate: min=2027-12-15 00:00:00, max=2055-05-15 00:00:00
...
### Date/Datetime Column Statistics
```
dt_start: min=1986-06-30, max=2023-07-27
dt_end: min=1986-10-31, max=2023-09-29
```
...
### Date/Datetime Column Statistics
```
datadate: min=1959-01-31 00:00:00, max=2025-05-31 00:00:00
```
...
### Date/Datetime Column Statistics
```
date: min=1926-07-31 00:00:00, max=2025-03-31 00:00:00
