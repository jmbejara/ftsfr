...
**Size:** 122454 bytes | **Type:** Parquet | **Shape:** 6,414 rows × 7 columns
...
DGS1: min=0.04, max=5.49, mean=1.91, median=1.37
...
### Date/Datetime Column Statistics
```
DATE: min=2001-01-01 00:00:00, max=2025-07-31 00:00:00
```
