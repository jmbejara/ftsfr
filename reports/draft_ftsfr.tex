...
\newcommand{\allsources}{Sources: Bloomberg, Board of Governors of the Federal Reserve System, Center for Research in Security Prices, Compustat, Call Reports, OptionMetrics, S\&P Global, WRDS Bond Returns, Open Source Bond Asset Pricing, He, Kelly, and Manela (2017), Authors' analysis}
...
\midrule
CDS-Bond & WRDS Bond Returns; Center for Research in Security Prices; S\&P Global CDS and RED Entity \\
...
\begin{figure}[h]
  ...
  \end{tabular}
  \floatsource{Sources: S\&P Global, WRDS Bond Returns, Center for Research in Security Prices, Authors' analysis}
  \label{fig:cds_basis}
\end{figure}
...
daily S\&P Global bond pricing source alongside the WRDS Bond Returns filter;
