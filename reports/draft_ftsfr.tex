...
% \begin{figure}
% \centering
% \includegraphics[width=0.75\textwidth]{../_output/example_plot.png}
...
The following website is helpful for generating tables manually: 
\url{https://www.tablesgenerator.com/}. You can also automatically generate tables from Pandas DataFrames with this method: 
