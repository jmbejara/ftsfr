...
\begin{itemize}
    ...
    \item AutoARIMA: Standard Autoregressive Integrated Moving Average model based on the statsmodel implementation, following \cite{Box2013} and \cite{Hyndman2008}.
