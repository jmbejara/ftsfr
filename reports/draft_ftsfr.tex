...
CDS Portfolio & S\&P Global CDS (formerly Markit) \\
Commodity & Bloomberg Terminal \\
Corporate Bond & WRDS TRACE, following Open Source Bond Asset Pricing$^{a}$  \\
Corporate Portfolio & WRDS TRACE, following Open Source Bond Asset Pricing \\
CRSP Stock & Center for Research in Security Prices (CRSP) \\
CRSP Stock (ex-div) & Center for Research in Security Prices (CRSP) \\
...
Bank Leverage & WRDS Bank Regulatory Call Reports, following \citet{Drechsler2017} \\
BHC Cash Liquidity & WRDS Bank Regulatory Call Reports, following \citet{Drechsler2017} \\
BHC Leverage & WRDS Bank Regulatory Call Reports, following \citet{Drechsler2017} \\
HKM Daily Factor & CRSP and Compustat, following \citet{He2017}$^{d}$\\
HKM Monthly Factor & CRSP and Compustat, following \citet{He2017} \\
HKM All Factor & CRSP and Compustat, following \citet{He2017} \\
...
\floatsource{Sources: Bloomberg, Board of Governors of the Federal Reserve System, Center for Research in Security Prices, U.S. Call Reports, WRDS TRACE, OptionMetrics, S\&P Global, Authors' analysis}
\end{table}
...
\begin{figure}[h]
  ...
  \end{tabular}
  \floatsource{Sources: S\&P Global, WRDS Bond Returns, CRSP Treasury, Authors' analysis}
  \label{fig:cds_basis}
\end{figure}
...
\floatsource{Sources: openbondassetpricing.com (OSBAP 2025 main panel), Authors' analysis}
\end{table}
...
\floatsource{Sources: openbondassetpricing.com, Authors' analysis}
\end{table}
...
\floatsource{Sources: WRDS (CRSP, Compustat, OptionMetrics), Authors' analysis}
\end{table}
...
\begin{figure}[h]
    ...
    \floatsource{Sources: WRDS TRACE, openbondassetpricing.com, He, Kelly, and Manela (2017), Authors' analysis}
