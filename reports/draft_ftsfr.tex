...
\begin{abstract}
    ...
    Holding the data fixed and evaluating roughly a dozen univariate methods without exogenous regressors, we find that asset returns remain near-unforecastable in this setting ($R^2_{\text{oos}} \approx 0$) while basis spreads and supervisory indicators yield meaningful gains for global machine-learning methods. 
