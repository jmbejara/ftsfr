...
\begin{figure}[h!]
  ...
  \begin{tabular}{@{}c@{}}
    ...
    \small Replicated findings of CDS arbitrage spreads
  \end{tabular}
  \caption{CDS Arbitrage spreads}\label{fig:myfig}
\end{figure}
\vspace{\floatsep}
...
\begin{figure}[h!]
  ...
  \begin{tabular}{@{}c@{}}
    ...
    \small Replicated findings of CIP arbitrage spreads
  \end{tabular}
  \caption{CIP Arbitrage spreads}\label{fig:myfig}
\end{figure}
\FloatBarrier
