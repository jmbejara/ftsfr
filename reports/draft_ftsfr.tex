...
\begin{itemize}
    ...
    \begin{itemize}
        \item Asset return series spanning equities (Fama-French portfolios), corporate bonds, U.S. Treasuries, sovereign bonds, foreign exchange rates, commodity futures, credit default swaps (CDS), and options
    ...
    \item All implementations are fully open source with best practices for reproducibility, including:
    \begin{itemize}
        \item Automated data pipeline using \texttt{dodo.py} for systematic data pulling and processing
        \item Virtual environments ensuring perfect reproducibility across different computing environments  
        \item Comprehensive documentation of data sources, cleaning procedures, and validation steps
        \item Public availability of all code at \url{https://github.com/jmbejara/ftsfr} and processed datasets for researchers with appropriate data access
    \end{itemize}
\end{itemize}
...
\section{Additional Financial Datasets}
