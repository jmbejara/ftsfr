...
\title{Benchmarking Forecasting Methods for Financial Stability: An Open-Source Financial Time Series Forecasting Repository}
...
\begin{figure}
  ...
  \caption{Comparison of CIP Arbitrage spreads}\label{fig:myfig}
\end{figure}
...
\begin{figure}
  ...
  \caption{Comparison of CDS Arbitrage spreads}\label{fig:myfig}
\end{figure}
