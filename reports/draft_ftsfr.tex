...
The code that automates the data pull, cleaning, and formatting is available on \href{https://github.com/jmbejara/ftsfr}{GitHub}. Table~\ref{tab:datasets} provides a comprehensive overview of all datasets included in our benchmark, organized by asset class and methodology. 
...
Corporate Bond & WRDS TRACE via \href{https://openbondassetpricing.com/}{Open Source Bond Asset Pricing}  \\
...
\midrule
CDS-Bond & WRDS TRACE via Open Source Bond Asset Pricing, S\&P Global CDS and RED Entity (formerly Markit) \\
...
\midrule
Bank Cash Liquidity & U.S. Call Reports, via Phillip Schnabl's \href{https://pages.stern.nyu.edu/~pschnabl/data/data_callreport.htm}{website}\footnote{See \url{https://pages.stern.nyu.edu/~pschnabl/data/data_callreport.htm}} \\
Bank Leverage & ibid. \\
BHC Cash Liquidity & ibid. \\
BHC Leverage & ibid. \\
HKM Daily Factor & Author, Asaf Manela's website \href{https://asafmanela.github.io/data/}{website}\footnote{See \url{https://asafmanela.github.io/data/}}\\
HKM Monthly Factor & ibid. \\
HKM All Factor & ibid. \\
Treasury Yield Curve & Yield Curve Data from Board of Governors of the Federal Reserve System\footnote{See \url{https://www.federalreserve.gov/data/nominal-yield-curve.htm}} \\
\bottomrule
\end{tabular}
\caption*{\emph{Source: Authors' creation}}
\end{table}
...
\input{../_output/forecasting2/filtered_dataset_statistics_tabular.tex}
\vspace{0.1cm}
...
We report three complementary error measures: root mean squared error (RMSE), mean absolute scaled error (MASE), and relatieve mean absolute scaled error (rMASE). 
We report the results using mean absolute error (MAE) and  Symmetric Mean Absolute Percentage Error (sMAPE) in the appendix. Each error metrics answers a slightly different question and, taken together, they balance interpretability, robustness, and cross-series comparability. I first define these error metrics and discuss their relative strengths.
...
\input{../_output/forecasting2/mase_pivot_tabular.tex}
\caption*{
...
\input{../_output/forecasting2/relative_mase_pivot_tabular.tex}
\caption*{
    \scriptsize
...
\input{../_output/forecasting2/rmse_pivot_tabular.tex}
\vspace{0.1cm}
...
\input{../_output/forecasting2/smape_pivot_tabular.tex}
\vspace{0.1cm}
...
\input{../_output/forecasting2/mae_pivot_tabular.tex}
\vspace{0.1cm}
