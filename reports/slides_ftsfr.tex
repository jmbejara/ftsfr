...
\begin{frame}
  ...
  \item \textbf{Rolling windows:} up to \alert{6 expanding cross-validation windows}, limited by the shortest surviving series
...
\begin{frame}[plain]
    ...
    \vspace{0.2cm}
    \resizebox{0.98\textwidth}{!}{\input{../_output/forecasting/paper/mase_pivot_tabular.tex}}
  \end{frame}
  ...
  \begin{frame}[plain]
    ...
    \vspace{0.2cm}
    \resizebox{0.98\textwidth}{!}{\input{../_output/forecasting/paper/relative_mase_pivot_tabular.tex}}
  \end{frame}
...
\end{frame}
  ...
  \begin{frame}[plain]
    ...
    \vspace{0.2cm}
    \resizebox{0.98\textwidth}{!}{\input{../_output/forecasting/paper/median_mase_summary_tabular.tex}}
  \end{frame}
  ...
  \begin{frame}[plain]
    ...
    \vspace{0.2cm}
    \resizebox{0.98\textwidth}{!}{\input{../_output/forecasting/paper/model_summary_by_category_tabular.tex}}
  \end{frame}
