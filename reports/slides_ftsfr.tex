...
\begin{frame}
  ...
  \end{itemize}
  \vspace{0.3cm}
  \item \alert{Multiple error metrics:}
  \begin{itemize}
    \item MASE: Scale-free comparison across datasets
    \item RMSE: Magnitude of forecasting errors
  \end{itemize}
  \vspace{0.3cm}
...
\begin{frame}
  ...
  \begin{itemize}
  \item Relative MASE: Performance compared to Naive baseline
  \begin{itemize}
    \item Values $<$ 1.0 = better than Naive
    \item Values $>$ 1.0 = worse than Naive
  \end{itemize}
  \item RMSE: Actual magnitude of errors in original units
...
\begin{frame}[plain]
    ...
    \centering
    \textbf{RMSE Results by Dataset and Model}\\
    \vspace{0.2cm}
    \scalebox{0.9}{%
...
\begin{itemize}
  ...
  \item Multiple error metrics for robust comparison
