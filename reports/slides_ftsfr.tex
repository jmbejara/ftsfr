...
\begin{frame}[plain]
  ...
  \begin{frame}[plain]
    ...
    \vspace{0.2cm}
    \input{../output/forecasting/median_mase_summary_tabular.tex}
  \end{frame}

\begin{frame}
  \frametitle{Key Finding: No Universal Best Model}
  \centering
  \includegraphics[width=0.9\textwidth]{\PathToOutput/forecasting/relative_mase_heatmap.png}
  \vspace{0.2cm}
...
%     \vspace{0.2cm}
%     \scalebox{0.9}{%
%       \input{../output/forecasting/r2_oos_pivot_tabular.tex}%
%     }
%   \end{frame}
