...
\item Since data cannot be redistributed, we provide open source code that enables researchers to download and use the exact datasets and methods used in the paper
  ...
  \end{itemize}
    \begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{\PathToAssets/ftsfr_github.png}
    \end{figure}
\end{frame}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{\PathToAssets/m_competitions.png}
\end{figure}
\end{frame}
...
\begin{frame}
  \frametitle{MASE Analysis: Key Patterns}
  \begin{itemize}
...
\end{frame}
  ...
  \begin{frame}[plain]
    ...
    \vspace{0.2cm}
    \resizebox{0.98\textwidth}{!}{\input{\PathToOutput/forecasting/paper/model_summary_by_category_tabular.tex}}
  \end{frame}
