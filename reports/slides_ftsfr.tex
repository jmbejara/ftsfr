...
\begin{frame}[plain]
  ...
  \vspace{0.2cm}
  \scalebox{0.9}{%
    \input{../output/forecasting2/dataset_statistics_tabular.tex}%
  }
\end{frame}
...
%     \vspace{0.2cm}
%     \scalebox{0.9}{%
%     \input{../output/forecasting2/filtered_dataset_statistics_tabular.tex}
%     }
%   \end{frame}
...
\begin{frame}[plain]
    ...
    \vspace{0.2cm}
    \input{../output/forecasting2/mase_pivot_tabular.tex}
  \end{frame}
  ...
  \begin{frame}[plain]
    ...
    \vspace{0.2cm}
    \input{../output/forecasting2/relative_mase_pivot_tabular.tex}
  \end{frame}
  ...
  \begin{frame}[plain]
    ...
    \vspace{0.2cm}
    \input{../output/forecasting3/median_mase_summary_tabular.tex}
  \end{frame}

\begin{frame}
  \frametitle{Key Finding: No Universal Best Model}
  \centering
  \includegraphics[width=0.9\textwidth]{\PathToOutput/forecasting3/relative_mase_heatmap.png}
  \vspace{0.2cm}
...
%     \vspace{0.2cm}
%     \scalebox{0.9}{%
%       \input{../output/forecasting3/r2_oos_pivot_tabular.tex}%
%     }
%   \end{frame}
