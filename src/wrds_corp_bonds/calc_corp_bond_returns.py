...
if __name__ == "__main__":
    bond_returns = pd.read_parquet(DATA_DIR / "corporate_bond_returns.parquet")
    deciled_bond_returns = assign_cs_deciles(bond_returns)
    # Value-weighted returns
    value_weighted = calc_value_weighted_decile_returns(deciled_bond_returns, value_col="BOND_VALUE")
