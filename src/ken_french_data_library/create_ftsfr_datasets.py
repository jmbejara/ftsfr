...
french_portfolios_25_daily_size_and_bm = load_french_portfolios_25_daily_size_and_bm(data_dir=DATA_DIR)
french_portfolios_25_daily_size_and_op = load_french_portfolios_25_daily_size_and_op(data_dir=DATA_DIR)
french_portfolios_25_daily_size_and_inv = load_french_portfolios_25_daily_size_and_inv(data_dir=DATA_DIR)

# Convert to long format
french_portfolios_25_daily_size_and_bm = convert_wide_to_long_format(french_portfolios_25_daily_size_and_bm)
french_portfolios_25_daily_size_and_op = convert_wide_to_long_format(french_portfolios_25_daily_size_and_op)
french_portfolios_25_daily_size_and_inv = convert_wide_to_long_format(french_portfolios_25_daily_size_and_inv)

# Save the datasets
french_portfolios_25_daily_size_and_bm.to_parquet(DATA_DIR / "ftsfr_french_portfolios_25_daily_size_and_bm.parquet")
french_portfolios_25_daily_size_and_op.to_parquet(DATA_DIR / "ftsfr_french_portfolios_25_daily_size_and_op.parquet")
french_portfolios_25_daily_size_and_inv.to_parquet(DATA_DIR / "ftsfr_french_portfolios_25_daily_size_and_inv.parquet")