...
def get_available_datasets(module_requirements, data_dir, datasets_toml_path="datasets.toml"):
    """
    ...
    for module_name, is_available in module_requirements.items():
        ...
        if module_name in datasets_config and isinstance(datasets_config[module_name], dict):
            ...
            for key, value in module_config.items():
                ...
                if key.startswith("ftsfr_") and isinstance(value, dict) and "description" in value:
