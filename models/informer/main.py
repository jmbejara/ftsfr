...
def forecast_informer(df, test_split, freq, seasonality, forecast_horizon):
    """
    Fit Informer model and return MASE
...
if __name__ == "__main__":
    ...
    print(f"Running Informer forecasting for {len(entities)} entities...")
    ...
    results_df.to_csv(OUTPUT_DIR / "raw_results" / "informer_results.csv", index=False)
