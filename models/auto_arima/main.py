...
def forecast_auto_arima(df, test_ratio, seasonality):
    """
    Fit AutoARIMA model and return MASE
    ...
    try:
        ...
        estimator = AutoARIMA(season_length = seasonality)
        ...
        print(f"Error in AutoARIMA forecasting: {e}")
        return np.nan
...
if __name__ == "__main__":
    ...
    # Local forecasting
    print(f"Running AutoARIMA forecasting for {len(entities)} entities...")
    ...
    for entity in tqdm(entities):
        ...
        # Get MASE using AutoARIMA
        entity_mase = forecast_auto_arima(entity_data, test_ratio, seasonality)
    ...
    results_file = OUTPUT_DIR / "raw_results" / f"auto_arima_{dataset_name}_results.csv"
