...
def forecast_auto_theta(df, test_ratio, seasonality):
    """
    Fit AutoTheta model and return MASE
    ...
    try:
        ...
        estimator = AutoTheta(season_length = seasonality)
        ...
        print(f"Error in AutoTheta forecasting: {e}")
        return np.nan
...
if __name__ == "__main__":
    ...
    # Local forecasting
    print(f"Running AutoTheta forecasting for {len(entities)} entities...")
    ...
    for entity in tqdm(entities):
        ...
        # Get MASE using AutoTheta
        entity_mase = forecast_auto_theta(entity_data, test_ratio, seasonality)
    ...
    results_file = OUTPUT_DIR / "raw_results" / f"auto_theta_{dataset_name}_results.csv"
