...
def forecast_auto_ces(df, test_ratio, seasonality):
    """
    Fit AutoCES model and return MASE
    ...
    try:
        ...
        estimator = AutoCES(season_length = seasonality)
        ...
        print(f"Error in AutoCES forecasting: {e}")
        return np.nan
...
if __name__ == "__main__":
    ...
    # Local forecasting
    print(f"Running AutoCES forecasting for {len(entities)} entities...")
    ...
    for entity in tqdm(entities):
        ...
        # Get MASE using AutoCES
        entity_mase = forecast_auto_ces(entity_data, test_ratio, seasonality)
    ...
    results_file = OUTPUT_DIR / "raw_results" / f"auto_ces_{dataset_name}_results.csv"
