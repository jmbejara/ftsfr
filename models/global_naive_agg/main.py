"""
GlobalNaiveAggregate using darts

Performs both local and global forecasting using a GlobalNaiveAggregate. Reports both mean and
...
if __name__ == "__main__":
    ...
    global_naive_agg_obj = DartsGlobal(GlobalNaiveAggregate(
    ...
    global_naive_agg_obj.main_workflow()