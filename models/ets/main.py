...
Performs both local forecasting using ETS. Reports both mean and
...
def forecast_ets(train_data, test_data, seasonality):
    """
    ...
    try:
        ...
        # Holts ets
        estimator = ExponentialSmoothing(trend=ModelMode.ADDITIVE, seasonal=SeasonalityMode.NONE)
...
if __name__ == "__main__":
    ...
    # This step below is mportant for ets since it can't handle nans
    # A large outlier value helps ets treat it as a nan
    ...
    for entity in tqdm(entities):
        ...
        # Get MASE using ETS
        entity_mase = forecast_ets(train_data, test_data, seasonality)
