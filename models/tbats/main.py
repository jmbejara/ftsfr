...
Performs both local forecasting using TBATS. Reports both mean and
...
def forecast_tbats(train_data, test_data, seasonality):
    """
    Fit TBATS model and return MASE
    ...
    try:
        ...
        estimator = TBATS(season_length = seasonality)
...
if __name__ == "__main__":
    ...
    print(f"Running TBATS forecasting for {len(entities)} entities...")
    ...
    for entity in tqdm(entities):
        ...
        # Get MASE using TBATS
        entity_mase = forecast_tbats(train_data, test_data, seasonality)
    ...
    results_df.to_csv(OUTPUT_DIR / "raw_results" / "tbats_results.csv", index=False)
