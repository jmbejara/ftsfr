...
def forecast_auto_ets(df, test_ratio, seasonality):
    """
    Fit AutoETS model and return MASE
    ...
    try:
        ...
        estimator = AutoETS(season_length = seasonality)
        ...
        print(f"Error in AutoETS forecasting: {e}")
        return np.nan
...
if __name__ == "__main__":
    ...
    # Local forecasting
    print(f"Running AutoETS forecasting for {len(entities)} entities...")
    ...
    for entity in tqdm(entities):
        ...
        # Get MASE using AutoETS
        entity_mase = forecast_auto_ets(entity_data, test_ratio, seasonality)
    ...
    results_file = OUTPUT_DIR / "raw_results" / f"auto_ets_{dataset_name}_results.csv"
