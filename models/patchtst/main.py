...
def get_patchtst_forecasts_global(
...
def get_patchtst_forecasts_local(lag, df, frequency, external_forecast_horizon=None):
    ...
    for entity in tqdm(entities):
        ...
        entity_mase = get_patchtst_forecasts_global(
            lag=lag,
            df=entity_data,
...
if __name__ == "__main__":
    ...
    mase_values = get_patchtst_forecasts_local(
    ...
    global_mase = get_patchtst_forecasts_global(
        lag=50,
        df=proc_df,
        test_ratio=0.2,
        frequency="1B",
