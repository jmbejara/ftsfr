...
def forecast_prophet(df, test_ratio, seasonality):
    """
    ...
    try:
        ...
        # which has been copied from darts documentation:
...
if __name__ == "__main__":
    ...
    for entity in tqdm(entities):
        ...
        entity_mase = forecast_prophet(entity_data, test_ratio, seasonality)
    ...
    results_file = OUTPUT_DIR / "raw_results" / f"prophet_{dataset_name}_results.csv"
